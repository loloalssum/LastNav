...
public class PrayTimeActivity extends AppCompatActivity {
    private static final String TAG = "PrayTimeActivity";
    private static final int ACTIVITY_NUM = 1;

    private Context mContext = PrayTimeActivity.this;
    ...
    public static void main(String[] args) {
        ...
        PrayTimeActivity prayers = new PrayTimeActivity();
